...
public class CharacterManager : MonoBehaviour
{
    ...
    public Character GetCharacter(string characterName, bool createCharacterIfDoesNotExist = true , bool enbleCreatedCharacterOnStart = true)
    {
        int index = -1;
        ...
        {
            return CreateCharacter(characterName, enbleCreatedCharacterOnStart);
        }

        return null;
    }
    public Character CreateCharacter(string characterName, bool enbleOnStart =true)
    {
