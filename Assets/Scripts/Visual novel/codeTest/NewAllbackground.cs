...
public class NewAllbackground : MonoBehaviour
{
    public static NewAllbackground instance;
...
public class GRAPHIC_LAYER
{
    ...
    public class GRAPHIC_OBJECT
    {
        ...
        {
            this.layer = layer;
            GameObject ob = Object.Instantiate(NewAllbackground.instance.graphicPrefab, NewAllbackground.instance.transform) as GameObject;
            ob.SetActive(true);
        ...
        public void Enable(float speed = 1f)
        {
            ...
            if (!isEnabling)
            {
                ...
                if (settingVisibility != null)
                    NewAllbackground.instance.StopCoroutine(settingVisibility);

                settingVisibility = NewAllbackground.instance.StartCoroutine(SetVisibility(1f));
            }
        }
        ...
        public void Disable(float speed = 1f)
        {
            ...
            if (!isDisabling)
            {
                ...
                settingVisibility = NewAllbackground.instance.StartCoroutine(SetVisibility(0f));
            }
        }
        ...
        IEnumerator SetVisibility(float alpha)
        {
            ...
            {
                canvasgroup.alpha = Mathf.MoveTowards(canvasgroup.alpha, alpha, layer.transitionSpeed * NewAllbackground.transitionSpeed * Time.deltaTime);
