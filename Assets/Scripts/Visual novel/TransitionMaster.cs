...
public class TransitionMaster : MonoBehaviour
{
	...
	public static void TransitionLayer(Allbackground.LAYER layer, Texture2D targetImage, Texture2D transitionEffect, float speed = 1, bool smooth = false)
	{
	...
	static IEnumerator TransitioningLayer(Allbackground.LAYER layer, Texture2D targetTex, Texture2D transitionEffect, float speed, bool smooth)
	{
	...
	static IEnumerator TransitioningLayerToNull(Allbackground.LAYER layer, Texture2D transitionEffect, float speed, bool smooth)
	{
